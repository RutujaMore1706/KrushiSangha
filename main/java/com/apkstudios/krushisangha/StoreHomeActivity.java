...
public class StoreHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = (DrawerLayout) findViewById(R.id.drawer_store_home);
        navigationView = (NavigationView) findViewById(R.id.navigation_view_store_home);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.logout:
                        ...
                        Intent intent = new Intent(StoreHomeActivity.this,MainActivity.class);
    ...
    private void displayMessage(String s) {
        ...
        Snackbar.make(findViewById(R.id.drawer_store_home), s, Snackbar.LENGTH_LONG).show();
