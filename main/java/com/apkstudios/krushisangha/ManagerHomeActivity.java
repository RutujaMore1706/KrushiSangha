...
public class ManagerHomeActivity extends AppCompatActivity {
    ...
    private AppCompatButton manage_farmer_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manage_farmer_btn = findViewById(R.id.manage_farmer_btn);
        manage_farmer_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle bundle = new Bundle();
                bundle.putString("email",pref.getString(Constants.EMAIL,""));
                Intent intent = new Intent(ManagerHomeActivity.this,ManagerManageFarmerActivity.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        });

        drawerLayout = (DrawerLayout) findViewById(R.id.drawer_manager_home);
        navigationView = (NavigationView) findViewById(R.id.navigation_view_manager_home);
    ...
    private void displayMessage(String s) {
        ...
        Snackbar.make(findViewById(R.id.drawer_manager_home), s, Snackbar.LENGTH_LONG).show();
